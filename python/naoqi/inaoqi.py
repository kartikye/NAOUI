...
class baseModule(_object):
    ...
    def methodMissing0(*args): return _inaoqi.baseModule_methodMissing0(*args)
    def methodMissing1(*args): return _inaoqi.baseModule_methodMissing1(*args)
    def methodMissing2(*args): return _inaoqi.baseModule_methodMissing2(*args)
    def methodMissing3(*args): return _inaoqi.baseModule_methodMissing3(*args)
    def methodMissing4(*args): return _inaoqi.baseModule_methodMissing4(*args)
    def methodMissing5(*args): return _inaoqi.baseModule_methodMissing5(*args)
    def methodMissing6(*args): return _inaoqi.baseModule_methodMissing6(*args)
...
class resourceSection(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, resourceSection, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, resourceSection, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _inaoqi.new_resourceSection(*args)
        try: self.this.append(this)
        except: self.this = this
    def release(*args): return _inaoqi.resourceSection_release(*args)
    __swig_destroy__ = _inaoqi.delete_resourceSection
    __del__ = lambda self : None;
resourceSection_swigregister = _inaoqi.resourceSection_swigregister
resourceSection_swigregister(resourceSection)
